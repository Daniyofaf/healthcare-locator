...
class SpecializedHospitalController extends AdminController
{
     ...
     * @var string
     */
    protected $title = 'SpecializedHospital';
    ...
    {
        $grid = new Grid(new SpecializedHospital());

        $grid->column('sh_id', __('sh id'));
        $grid->column('sh_name', __('SpecializedHospital name'));
    ...
    {
        $show = new Show(SpecializedHospital::findOrFail($id));

        $show->field('sh_id', __('SpecializedHospital id'));
        $show->field('sh_name', __('SpecializedHospital name'));
    ...
    {
        $form = new Form(new SpecializedHospital());
        $form->text('sh_id', __('SpecializedClinic id'));
